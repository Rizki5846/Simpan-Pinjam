...
<div class="main-box">
    <div class="card-header-custom">Tambah Data Anggota</div>
    ...
    <div class="card-body mt-4">
        ...
        <form action="{{ route('anggota.create.store') }}" method="POST">
            @csrf
            ...
            <div class="row">
             ...
             <div class="col-md-12 mb-4">
                    ...
                    <select class="form-select @error('status_kelayakan') is-invalid @enderror" name="status_kelayakan">
                        <option value="">-- Pilih Status --</option>
